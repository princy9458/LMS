...
export default function TopicTagsPage() {
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-semibold text-zinc-900">Topic Tags</h1>
        <p className="text-sm text-zinc-500">Manage topic tags.</p>
      </div>
